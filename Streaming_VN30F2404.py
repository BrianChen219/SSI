...
def name_json():
    ...
    if platform.system() == 'Windows':
        path_data = 'L:\Project\Finance API\Architecture-automation-from-Finance-data-API-to-Cloud-Database-in-real-time\data\\vn30f2404\\'
    else:
        path_data = 'Finance API/Architecture-automation-from-Finance-data-API-to-Cloud-Database-in-real-time/data/vn30f2404/'
